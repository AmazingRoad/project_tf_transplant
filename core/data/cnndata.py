...
from core.data import coord_transforms, transforms
...
class PatchCreator(data.Dataset):
    ...
    :py:class:`core.training.trainer.train_utils.DelayedDataLoader`, if it is
    used with :py:class:`core.training.trainer.Trainer``).
    ...
    warp images themselves, core performs warping transformations on
    ...
    :py:meth:`core.data.cnndata.warp_slice()`.
    ...
    Args:
        ...
        warp_kwargs: kwargs that are passed through to
            :py:meth:`core.data.coord_transforms.get_warped_slice()`.
        ...
        transform: Transformation function to be applied to ``(inp, target)``
            ...
            :py:class:`core.data.transforms.Compose`.
            See :py:mod:`core.data.transforms`. for some implementations.
    ...
    def warp_cut(
        ...
        """
        (Wraps :py:meth:`core.data.coord_transforms.get_warped_slice()`)
